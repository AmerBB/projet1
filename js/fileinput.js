...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _uploadSingle: function (i, files, allFiles) {
            ...
            fnSuccess = function (data, textStatus, jqXHR) { 
                ...
                progresscomplete( jqXHR.responseJSON ); ///// fin upload photo
            };
            fnComplete = function () {
                setTimeout(function () {
                    if (self.showPreview) {
        ...
        _setAsyncUploadStatus: function (previewId, pct, total) {
            var self = this, sum = 0;
            self._setProgress(parseInt(pct) - 1, $('#' + previewId).find('.file-thumb-progress'));
            self.uploadStatus[previewId] = pct-1;
        ...
        _change: function (e) {
            ...
            if (isDragDrop) {
                UploadImage_(); /// execute upload image
                tfiles = [];
                while (files[i]) {
                    f = files[i];
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgSizeTooLarge: 'Votre image dépasse <span class="popover-color">3Mo</span>',
        ...
        msgInvalidFileExtension: '<span class="popover-color">Le format de l\' image</span> n\'est pas autorisé',
