            ...
            <div class="col-md-12">
              <div class="box box-warning  box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Modificattion de la page Merci</h3>
               ...
               <form class="form-horizontal" method="post" action="">
                    ...
                    <?php 
                     ...
                     ?>   
                        ...
                        <div class="form-group"> 
                          <div class="col-sm-12"> 
                            <textarea class="form-control"  name="champ4"><?= $content['champ4'] ?></textarea>
                          </div>
                        </div> 
                        <div class="form-group"> 
                          <div class="col-sm-12">
                        ...
                        <div class="form-group"> 
                          <div class="col-sm-12">
                             <textarea type="text" class="form-control"  name="champ7"><?= $content['champ7'] ?></textarea>
                          </div>
                        </div> 
                        <div class="form-group"> 
                          <div class="col-sm-12">
                        ...
                        <div class="form-group"> 
                          <div class="col-sm-12">
                             <textarea type="text" class="form-control"  name="champ9"><?= $content['champ9'] ?></textarea>
                          </div>
                        </div> 
